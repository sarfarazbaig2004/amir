...
class _MachineOverviewScreenState extends State<MachineOverviewScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: const Color(0xFFF3F4F6),
      appBar: AppBar(title: const Text('TESTING QUIK IoT')),
      body: Padding(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 24),
          AspectRatio(aspectRatio: 2.0, child: _buildTrendChart(trend)),
          const SizedBox(height: 24),
          Row(
            children: [
              Expanded(
